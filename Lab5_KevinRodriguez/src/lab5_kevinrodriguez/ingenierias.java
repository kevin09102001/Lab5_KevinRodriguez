...
public class ingenierias extends carrera{
    ...
    public ingenierias(String tipo_carrera) {
        this.tipo_carrera = tipo_carrera;
    }

    public ingenierias(String tipo_carrera, String nombre, String Facultad, String Costo_Mensual, String Jefe_de_carrera) {
